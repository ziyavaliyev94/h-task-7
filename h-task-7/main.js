...
// const getData = () => {
//     let newData = users.filter((person) => person.height > 150);
//     console.log(newData);
// }
// getData()
...
// const getName = (name) =>{
//     let result = users.find((person)=> person.firstName == name);
//     console.log(result);
// }
// getName("Isabella")
...
//     let result = totalAge / users.length;
//     console.log(result);
// }
// getAllAge()
...
// const lineUpAge = () => {
//    let lineAp =  users.sort((a, b) => a.age - b.age)
//    console.log(lineAp);
...
//      let result = users.map((person) => person.company.title == "Web Developer");
//         console.log(result); 
